...
//define('AWS_KEY', get_option('rzon_amazon_key'));
define('AWS_KEY', $public_key);
 ...
 */
//define('AWS_SECRET_KEY', get_option('rzon_amazon_secret_Key'));
define('AWS_SECRET_KEY', $private_key);
 ...
 */
//define('AWS_ASSOC_ID', get_option('rzon_default_tracking_Id'));
define('AWS_ASSOC_ID', $affid);
 ...
 */
define('AWS_DEFAULT_LOCALE', $locale);
