...
/**
 * Constant: PAS_LOCALE_CHINA
 * 	Locale code for China
 */
define('PAS_LOCALE_CHINA', 'cn');

/**
 * Constant: PAS_LOCALE_SPAIN
 * 	Locale code for Spain
 */
define('PAS_LOCALE_SPAIN', 'es');

/**
 * Constant: PAS_LOCALE_ITALY
 * 	Locale code for Italy
 */
define('PAS_LOCALE_ITALY', 'it');
...
class AmazonPAS extends CloudFusion
{
	...
	public function pas_authenticate($action, $opt = null, $locale = null)
	{
		...
		{
			// Spain
			case PAS_LOCALE_SPAIN:
				$hostname = 'webservices.amazon.es';
				break;
				
			// China
			case PAS_LOCALE_CHINA:
				$hostname = 'webservices.amazon.cn';
				break;
				
			// Italy
			case PAS_LOCALE_ITALY:
	...
	public function cart_add($cart_id, $hmac, $offer_listing_id, $opt = null, $locale = null)
	{
		...
		else
		{
			...
			$opt['Item.1.ASIN'] = $offer_listing_id;
